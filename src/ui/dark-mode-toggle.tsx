export default function DarkMode() {
  return (
    <div class="flex items-center text-muted-foreground">
      <div
        id="moon"
        class="flex items-center justify-center rounded-full p-2.5 hover:text-foreground"
      ...
      <div
        id="sun"
        class="flex items-center justify-center rounded-full p-2.5 hover:text-foreground active:scale-95"
