...
export const buttonStyles = (props: ButtonProps) => {
  return cx(
    "group inline-flex h-9 items-center justify-center gap-2.5 whitespace-nowrap rounded-md px-4 py-2 text-md font-medium transition-colors first-letter:capitalize focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50",
